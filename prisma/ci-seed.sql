...
('ci-tenant-a', 'ci-tenant-a', 'CI Tenant A', '$2b$10$uwB6ea4ZwbDsH799mq3AYe3A8LIPEoGRRv83ZV5AJG7xTQvEP7hJi', 5, 3, '{"deposit_mode":"50_percent"}', TIMESTAMP '2026-01-01 00:00:00', TIMESTAMP '2026-01-01 00:00:00'),
('ci-tenant-b', 'ci-tenant-b', 'CI Tenant B', '$2b$10$uwB6ea4ZwbDsH799mq3AYe3A8LIPEoGRRv83ZV5AJG7xTQvEP7hJi', 2, 1, '{"deposit_mode":"100_percent"}', TIMESTAMP '2026-01-01 00:00:00', TIMESTAMP '2026-01-01 00:00:00');
