...
function main() {
  ...
  const flavors = [
    ...
    { name: "Maracuja", type: "RECHEIO", additionalPrice: 10, isSpecial: 0, imageUrl: "https://images.unsplash.com/photo-1546039907-7fa05f864c02?w=300&h=300&fit=crop", sortOrder: 7 },
  ];
  ...
  for (const f of flavors) {
    insertFlavor.run(uuid(), tenantId, f.name, f.type, f.additionalPrice, f.isSpecial, f.imageUrl, f.sortOrder);
  }

  const addons = [
    { name: "Topo de Bolo Personalizado", description: "Topo em acrilico com nome e idade", price: 35, imageUrl: "https://images.unsplash.com/photo-1535254973040-607b474cb50d?w=300&h=300&fit=crop", sortOrder: 0 },
    ...
    { name: "Cupcakes Decorados (12 un.)", description: "Cupcakes tematicos com cobertura", price: 55, imageUrl: "https://images.unsplash.com/photo-1587668178277-295251f900ce?w=300&h=300&fit=crop", sortOrder: 3 },
    { name: "Embalagem Premium", description: "Caixa decorativa com laco de fita", price: 25, imageUrl: "https://images.unsplash.com/photo-1549488344-cbb6c34cf1ac?w=300&h=300&fit=crop", sortOrder: 4 },
    { name: "Velas Personalizadas", description: "Kit de velas com numero da idade", price: 15, imageUrl: "https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=300&h=300&fit=crop", sortOrder: 5 },
  ];
  ...
  for (const d of blockedDates) {
    ...
    insertBlocked.run(uuid(), tenantId, dateStr, "Agenda Lotada");
  }

  console.log("[SUCCESS] Seed completed. Demo tenant created:");
